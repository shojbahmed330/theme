...
const TransactionHistory: React.FC<TransactionHistoryProps> = ({ transactions }) => {
  return (
    <div className="glass-tech p-8 md:p-10 rounded-[2.5rem] border-white/5 space-y-6 shadow-xl">
      <h3 className="text-xl font-black text-white uppercase tracking-tight flex items-center gap-3"><History className="text-pink-500"/> Recent <span className="text-pink-500">History</span></h3>
      <div className="space-y-4">
        ...
        )) : <div className="text-center py-10 text-slate-600 font-black uppercase tracking-[0.3em]">No records found.</div>}
      </div>
    </div>
  );
};
