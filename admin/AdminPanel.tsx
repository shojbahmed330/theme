...
import { Loader2, BarChart3, Users, CreditCard, Package as PackageIcon, Terminal, TrendingUp } from 'lucide-react';
...
const AdminPanel: React.FC<AdminPanelProps> = ({ user, onApprovePayment, onRejectPayment }) => {
  ...
  const handleUpdatePackage = async () => {
    ...
    await db.updatePackage(editingPackage.id, { name: editingPackage.name, tokens: editingPackage.tokens, price: editingPackage.price });
          ...
          <div className="max-w-6xl mx-auto">
            {activeTab === 'stats' && (
              <div className="space-y-8">
                ...
                <div className="glass-tech p-8 rounded-[3rem] border-white/5 h-[300px]">
